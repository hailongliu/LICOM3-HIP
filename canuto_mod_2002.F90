...
!981215 \pi value
      PARAMETER(pi_const=3.14159265358979312D0) !LPF20131014
!*****CD
...
!030324-27 Add shearless table as a function of the one variable (N_d^2/N^2) .
       REAL(r8) and2on2a1(-mt:mt),amtaun2a1(-mt:mt),dand2on2 &
        ...
        , theta_rcrp, theta_rcrn,ako,back_l_0 
!lhl20130925        ,visc_cbu_limit,diff_cbt_limit, theta_rcrp, theta_rcrn,ako,back_l_0 
