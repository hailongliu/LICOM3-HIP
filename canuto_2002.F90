...
!020923(First Day of Autumn)X Introduce an array for [\epsilon y], that is, dissipation times {\tau Shear}^2 .
      DIMENSION epsy(na)
!
            !if(mytid==0) print *,"ii,jj",ii,jj,iblock,rid !LPF
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'testouputisc',n,na,nmax,iblock 
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'z',z 
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'t',t
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'s',s
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'rh',rh
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'ri',ri
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'rid',rid
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'s2',s2
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'fricmx',fricmx
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'wndmix',wndmix
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'v_back',v_back
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'t_back',t_back
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'s_back',s_back
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'an2',ustar_
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'buoytur',buoytur
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'buoysol',buoysol
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'coriol',coriol
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'amld',amld
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'akm',akm
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'isurfuse',isurfuse
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'ifextermld,ifoutput',ifextermld,ifoutput  
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'slq2,slq2a,slq2b',slq2,slq2a,slq2b  
        !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'ifextermld,ifoutput',ifextermld,ifoutput  
...
!******
      kbot=n+1
!*****CD
         !if(mytid==32.and.ii==21.and.jj==22)write(169,*)'fricmx,nb,kbot',fricmx,nb,kbot
...
!       (N^d)^2/N^2 is a more accurate quantity.
        ...
        !and2on2 = and2/an2(k) !LPF20131016
...
!011107yXI ***Option to call instead of generic interpolation one tailored to exponential absolute nonlinear part.***
            IF(ifastexpabs.EQ.0) THEN
              CALL INTERP2D(ri1,rid1, &
                      ...
                      irimax,mt,mt0,dri)
            ELSE IF(ifastexpabs.EQ.1) THEN
          ! if(mytid==89.and.ii==37.and.jj==11)write(*,*)'ri1rid1-ok1',ri1,rid1,ii,jj !LPF20131017
          ! if(mytid==88.and.ii==37.and.jj==17)write(*,*)'ri1rid1-ok1,88',ri1,rid1,ii,jj !LPF20131017
          ! if(mytid==88.and.ii==37.and.jj==16)write(*,*)'ri1rid1-ok1,88',ri1,rid1,ii,jj !LPF20131017
          ! if(mytid==88.and.ii==36.and.jj==17)write(*,*)'ri1rid1-ok1,88',ri1,rid1,ii,jj !LPF20131017
           !if(mytid==32.and.ii==21.and.jj==22)write(*,*)'ri1rid1-ok1,32',ri1,rid1,ii,jj,slq2,sm,sh,ss !LPF20160728
...
!	Sound the alarm if have unrealizability outside expected range in angle.
       ...
       if (mytid.eq.0) then
         ...
         "************************************************"
	      ...
	      WRITE(*,*) "i=",ii,"j=",jj,"k=",k,"  ri(k)=",ri(k),"  rid(k)=",rid(k)
...
!011107yXI ***Option to call instead of generic interpolation one tailored to exponential absolute nonlinear part.***
            IF(ifastexpabs.EQ.0) THEN
              CALL INTERP2D(back_ri1,back_rid1, &
                      ...
                      irimax,mt,mt0,dri)
            ELSE IF(ifastexpabs.EQ.1) THEN
        !if(mytid==88.and.ii==27.and.jj==2)write(*,*)'back_ri1,rid1-ok2',back_ri1,back_rid1 !LPF20131017
...
!990412-13 Find \theta_r for the Ri_T = 0 case. Treat "0/0 = 1".
            ...
            ELSE
              theta_r = ATAN(ric/rit)
            END IF
     !  if (mytid.eq.0) write(*,*)'theta_r99=',theta_r 
!*****C
	    !theta_r = ATAN(ric/rit) !LPF20131015
       !if (mytid.eq.0) write(*,*)'theta_r=',theta_r 
!990111 Make sure the right choice of arctan(Ri_C/Ri_T) [\theta_r] is made.
!	Arctan only covers the range (-pi/2,pi/2) which theta_r may be outside.
...
!	Sound the alarm if have unrealizability outside expected range in angle.
       ...
       if (mytid.eq.0) then
        ...
        "************************************************"
	      ...
	      WRITE(*,*) "Unrealizability outside Ri>0 region. "
	      WRITE(*,*) "slq2=",slq2,"    sm=",sm," sh=",sh," ss=",ss
	      WRITE(*,*) "mytid=",mytid,"ii=",ii,"jj=",jj,"k=",k,"  ri(k)=",ri(k),"  rid(k)=",rid(k)
	      WRITE(*,*) "rit=",rit,"ric=",ric,"    theta_r=",theta_r
	      WRITE(*,*) "theta_r_deg =",theta_r_deg
	      WRITE(*,*) "itheta_r0=",itheta_r0," itheta_r1=",itheta_r1
	      WRITE(*,*) "n_theta_r_oct=",n_theta_r_oct 
...
!******Y
!lhl20131025          akm(k)=min(tmp*sm+v_back(k),visc_cbu_limit1)
!lhl20131025          akh(k)=min(tmp*sh+t_back(k),diff_cbt_limit1)
!lhl20131025          aks(k)=min(tmp*ss+s_back(k),diff_cbt_limit1)
!LPF20160730
!       akm(k)=tmp*sm
!       akh(k)=tmp*sm
!       aks(k)=tmp*sm
...
!lhl20131025      IF(n.GT.0) THEN
!lhl20131025        if(akm(1).lt.wndmix) akm(1)=wndmix
!lhl20131025        if(akh(1).lt.wndmix) akh(1)=wndmix
!lhl20131025        if(aks(1).lt.wndmix) aks(1)=wndmix
!lhl20131025      END IF
                  IF(n.GT.0) THEN
