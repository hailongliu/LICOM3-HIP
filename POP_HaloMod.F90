...
!      rcvStatus         ! MPI status flags
   integer (i4), dimension(MPI_STATUS_SIZE,100) :: &
      sndStatus,       &! MPI status flags
      rcvStatus         ! MPI status flags
...
!-----------------------------------------------------------------------
   ...
   if(halo%numMsgRecv > 100) then
   write(*,*) 'numMsgRecv',halo%numMsgRecv
   call exit
   end if
...
!-----------------------------------------------------------------------
   ...
   if (nxGlobal > 0) then
      ...
      case (POP_gridHorzLocCenter)   ! cell center location
         ...
         bufTripoleR8(nxGlobal ,1) = isign* &
         bufTripoleR8(nxGlobal ,1)
   ...
   if (nxGlobal > 0) then
      ...
      case (POP_gridHorzLocCenter)   ! cell center location
         ...
         do i = 1,nxGlobal/2 -1
            ...
            if ( isign == 1) then
               xavg = 0.5_r4*(x1 + x2)
               bufTripoleR4(i   ,1) = xavg
               bufTripoleR4(iDst,1) = xavg
            else
         ...
         bufTripoleR4(nxGlobal ,1) = isign* &
         bufTripoleR4(nxGlobal ,1)
   ...
   if (nxGlobal > 0) then
      ...
      case (POP_gridHorzLocCenter)   ! cell center location
         ...
         do i = 1,nxGlobal/2 - 1
            ...
            if ( isign == 1) then
               xavg = nint(0.5_r8*(x1 + x2))
               bufTripoleI4(i   ,1) = xavg
               bufTripoleI4(iDst,1) = xavg
            else
         ...
         bufTripoleI4(nxGlobal,1) = isign* &
         bufTripoleI4(nxGlobal,1)
   ...
   if (nxGlobal > 0) then
      ...
      case (POP_gridHorzLocCenter)   ! cell center location
         ...
         do i = 1,nxGlobal/2-1
            ...
            if ( isign == 1) then
               xavg = 0.5_r8*(x1 + x2)
               bufTripole(i   ,1,k) = xavg
               bufTripole(iDst,1,k) = xavg
            else
               xavg = 0.5_r8*(abs(x1) + abs(x2))
         ...
         bufTripole(nxGlobal,1,k) = isign* &
         bufTripole(nxGlobal,1,k)
         end do
   ...
   if (nxGlobal > 0) then
      ...
      case (POP_gridHorzLocCenter)   ! cell center location
         ...
         do i = 1,nxGlobal/2 - 1
            ...
            if ( isign == 1) then
               xavg = 0.5_r8*(x1 + x2)
               bufTripole(i   ,1,k,l) = xavg
               bufTripole(iDst,1,k,l) = xavg
            else
               xavg = 0.5_r8*(abs(x1) + abs(x2))
         ...
         bufTripole(nxGlobal,1,k,l) = isign* &
         bufTripole(nxGlobal,1,k,l)
         end do
         end do
!
...
!-----------------------------------------------------------------------
   ...
   if (POP_mastertask == POP_mytask) then 
      ...
      write(LICOM_stdout,'(a30,2(i13))') 'bufSize{Recv,Send} [words] : ',&
                                        bufSizeRecv, bufSizeSend
      write(LICOM_stdout,'(a30,2(i13))') 'num messages: {min,max}: ',    &
                                    minNumMsgRecv, maxNumMsgRecv
      write(LICOM_stdout,'(a45,2(i13),2x,e10.3)')                        &
